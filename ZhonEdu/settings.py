"""
Django settings for ZhonEdu project.
...
SECRET_KEY = 'django-insecure-p^o)ic)$dqqkpr$og2_y1_lmg)7q%y!130_b$j147yb#t+!4g@'
...
WSGI_APPLICATION = 'ZhonEdu.wsgi.application'
